...
public class AdapterPhieuXuat extends BaseAdapter {
    Context context;
    ArrayList<Phieu> list;

    public AdapterPhieuXuat(Context context, ArrayList<Phieu> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tv_ngay = row.findViewById(R.id.tv_phieu_ngay);
        TextView tv_gio = row.findViewById(R.id.tv_phieu_gio);
        ...
        tv_ngay.setText("Ngày Xuất");
        tv_gio.setText("Giờ Xuất");

        lin_rowPhieu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, QLTTPhieuXuat.class);
